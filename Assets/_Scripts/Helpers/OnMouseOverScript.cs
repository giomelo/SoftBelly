...
namespace _Scripts.Helpers
{
    ...
    {
        [SerializeField]
        private OutLineHolder objectOutline;
        [SerializeField]
        ...
        private void FixedUpdate()
        {
                    ...
                    layyer))
            {
                if(!isOver)
                {
                    ...
                    hit.transform.TryGetComponent(out objectOutline);
                    isOver = true;
                    if (objectOutline)
                    {
                        
                        objectOutline.outiline.enabled = true;
                    }
            ...
            else
            {
                ...
                {
                    isOver = false;
                  //  objectOutline = hit.transform.GetComponent<OutLineHolder>().outiline;
                  if (objectOutline)
                  {
                      objectOutline.outiline.enabled = false;
