    ...
    public class Pestle : BaseMachine
    {
        ...
        public override void CreateResult()
        {
            for (int i = 0; i < IngredientsSlots.Count; i++)
            {
                ...
                newSmashedPlant.Init(currentPlant.ItemId + "Amassada", ItemType.Amassada, currentPlant.SmashedPlant,currentPlant.Price,currentPlant.ItemProprietiesDescription + " Amassada", currentPlant);
