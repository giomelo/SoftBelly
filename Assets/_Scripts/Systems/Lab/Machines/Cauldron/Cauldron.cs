    ...
    public class Cauldron : Burn, ITimerMachine
    {
        ...
        public override void CreateResult()
        {
            ...
            for (int i = 0; i < ResultsSlots.Count; i++)
            {
                ...
                newBurned.name = currentPlant.ItemId + " Cozida";
                newBurned.Init(currentPlant.ItemId + " Cozida", ItemType.Cozida, currentPlant.BurnedPlant,currentPlant.Price, currentPlant.ItemProprietiesDescription + " Cozida",  currentPlant.BurnedPlant,currentPlant.MixedPlant, currentPlant.DriedPlant, currentPlant.PotionStuff, 
